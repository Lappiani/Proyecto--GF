...
- $\mathbf{w}:$ pesos relativos del portafolio.
- $\mathbf{\Sigma}:$ matriz de covarianza de los activos que componen el portafolio.
...
$$
\max_{\mathbf{w}} \left\{\mu - \delta \mathbf{w}^{\intercal}\mathbf{\Sigma}\mathbf{w}\right\}
$$
Sujeto a:
